...
# creating our marshaller to pull k,v pairs out drone instances attributes
class DroneSchema(ma.Schema):
  class Meta:
    # detailing which fields to pull out of our deone and send to API call + vice versa
...
drones_schema = DroneSchema(many = True)
  ...
  # take python class object like <Drone x273238215383655> = ugly
  # iterates through our field and adds them do a dictionary
  # drone_1
  # {
  #   'id': drone_1.id,
  #   'name': drone_1.name
